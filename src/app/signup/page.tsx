...
export default function Signup() {
    ...
    try {
      ...
      if (userCredential.user) {
        try {
          ...
          console.error('Error saving user data to Firestore:', firestoreErr);
  ...
  async function handleGoogleSignIn() {
    try {
      ...
      // If new user, save additional data to Firestore
      if (isNewUser && userCredential.user) {
        try {
          ...
          console.error('Error saving Google user data to Firestore:', firestoreErr);
          // Continue even if Firestore save fails - user is still authenticated
        }
      }
