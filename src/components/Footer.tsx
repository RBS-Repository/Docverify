      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4">
              Cutting-edge document and image verification solution that helps you identify fake documents and images quickly and accurately.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/cookies" className="text-gray-600 hover:text-primary-500">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-500 text-center">
            &copy; {currentYear} DocVerify. All rights reserved BMMC.
          </p>
        </div>
      </div>
    </footer>
